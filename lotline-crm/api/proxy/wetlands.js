...
export default function handler(req, res) {
  ...
  const params = new URLSearchParams({ where: '1=1', geometryType: 'esriGeometryEnvelope', geometry, inSR: '4326', outSR: '4326', spatialRel: 'esriSpatialRelIntersects', outFields: 'WETLAND_TYPE,ATTRIBUTE', maxAllowableOffset: '0', f: 'geojson', resultRecordCount: '1000' });
