...
const DEFAULT_LIST_FIELDS  = [
  'arv', 'total_estimated', 'net_profit', 'net_profit_after_financing', 'investor', 'cost_of_capital',
  'land', 'mobile_home',
  'county', 'state', 'acreage', 'parcel_id',
  'stage', 'deal_owner', 'lead_source',
...
function getFieldValue(deal, key) {
  switch (key) {
    ...
    case 'contract_signed_at':         return deal.contractDate ?? deal.contractSignedAt ?? null;
...
export default function DealOverview() {
  ...
  const filteredDeals = useMemo(() => allDeals.filter(deal => {
    ...
    if (filterLender && filterLender !== 'has' && filterLender !== 'none' && deal.investor !== filterLender) return false;
