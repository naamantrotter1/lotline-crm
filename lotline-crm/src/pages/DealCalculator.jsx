...
export default function DealCalculator() {
  ...
  // Whenever the resolved state or county changes, reset cost inputs to the
  // new state/county's defaults. Using the functional updater so purchasePrice
  // and loanAmount (which drive auto-tax fields) come from the latest prev.
  useEffect(() => {
